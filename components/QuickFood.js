        ...
        {data.map((item, index) => (
          <Pressable style={{ margin: 10 }} key={index}>
            <ImageBackground
              ...
              style={{ aspectRatio: 5 / 6, height: 160 }}
            ...
            <View style={{ flexDirection: "row", alignItems: "center", marginTop: 3 }}>
              ...
              <Text style={{ marginLeft: 3, fontSize: 11, fontWeight: "400" }}>{item.rating}</Text>
              <Text style={{ marginLeft: 3 }}>•</Text>
              <Text style={{ marginLeft: 3, fontSize: 11, fontWeight: "400" }}>{item.time}mins</Text>
            </View>
          </Pressable>
        ))}
      </ScrollView>
